...
import coding.spring_boot_mybatis.service.UserService;
...
public class UserController {
    ...
    // PUT /api/users/:id : 특정 ID 의 사용자 정보를 업데이트하고 업데이트된 정보를 반환
    @PutMapping("/{id}")
    public UserDTO updateUser(@PathVariable Long id, @RequestBody UserDTO userDTO) {
        userDTO.setId((id)); // 서비스 계층에서 convertToEntity 돌아가게 하려면
